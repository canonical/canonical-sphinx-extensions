...
You can then turn control whether contributors are displayed by setting the `display_contributors` field in the `html_context` variable:
...
The extension provides a `get_contributors_for_file` functions that can be used in your template.
